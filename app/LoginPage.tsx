            ...
            <div className="px-6 py-5">
              <div className="border border-blue-200 rounded-lg overflow-hidden mb-4 bg-blue-50">
                <div className="grid grid-cols-2 text-center text-sm font-semibold">
                  <button className="px-3 py-2 bg-blue-500 text-white" type="button">Login</button>
                  <button className="px-3 py-2 text-blue-700" type="button" onClick={onSwitchToRegister}>Register</button>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  >
                    {loading ? 'Secure Login...' : 'Secure Login'}
                  </button>
                </div>
              </form>
